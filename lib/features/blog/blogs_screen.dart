...
import 'package:mera_ashiana/data/services/blog_service.dart'; // Using the service
import 'package:mera_ashiana/features/blog/blog_detail_screen.dart'; // New Detail Screen
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text("Could not load blogs. Check your connection."),
          ),
        );
      }
    }
