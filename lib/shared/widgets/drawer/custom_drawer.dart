...
import 'package:mera_ashiana/shared/helpers/logout_helper.dart';
...
import 'package:mera_ashiana/features/blog/blogs_screen.dart';
...
import 'package:mera_ashiana/shared/widgets/drawer/widgets/drawer_header.dart';
import 'package:mera_ashiana/shared/widgets/drawer/widgets/drawer_footer.dart';
      ...
      child: SafeArea(
        child: Column(
          children: <Widget>[
            ...
            // 🔥 CLEAN FOOTER (LOGOUT HANDLED HERE)
            ValueListenableBuilder<bool>(
              valueListenable: AuthState.isLoggedIn,
              builder: (context, isLoggedIn, _) {
                return DrawerFooter(
